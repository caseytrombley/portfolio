const introText = `I'm a Senior Front-End Software Engineer with expertise in building intuitive, user-friendly web applications. My passion for drawing, JavaScript, and CSS drives me to create seamless, interactive experiences from the ground up.`;
...
const experience = [
  ...
  },
  {
    ...
    company: "Algaecal",
    dates: "December 2019 - August 2022",
    description: "Designed and developed javascript-based web apps. Developed front end systems. " +
...
const timelineData = [
  ...
  },
  {
    ...
    description: `
    <div class="body">
      <p>The early 2000s were a wild time. While the world was obsessed with The Lord of the Rings, I was on my own epic journey, slogging through mountains of CSS bugs in sprawling applications.
      This was before the fancy JavaScript frameworks we take for granted today—back then, you just had raw JS, trial-and-error, and the faint hope that Internet Explorer wouldn’t ruin your day (spoiler: it always did).
I earned my CSS chops the hard way, wrangling box models like they were feral beasts. “Pixel-perfect” was a phrase people actually said out loud, and I made it happen with blood, sweat, and liberal use of float: left. It was like living in a world where everything was a Rube Goldberg machine, but hey, it worked (most of the time).
      ...
      <div class="image"><div style="width:100%;height:0;padding-bottom:96%;position:relative;"><iframe src="https://giphy.com/embed/13FrpeVH09Zrb2" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div></div>
    </div>

    <div class="body">
      <div class="image"><img src='/2000s-2.jpg' alt='image' /></div>
      <p>
  ...
  },
  {
    ...
    <div class="body">
      ...
      <div class="image">
        <img src='/2010s-1.jpg' alt='image' />
      </div>
    </div>

    <div class="body">
      <div class="image"><img src='/2010s-2.jpg' alt='image' /></div>
      <p>
        ...
        <br/> <br/>The 2010s were a whirlwind of learning, adapting, and leveling up. The web wasn’t just a collection of pages anymore; it had evolved into a rich, dynamic ecosystem—and I was ready to keep pushing forward into whatever came next.
      </p>
  ...
  },
  {
    ...
    <div class="body">
      ...
      <div class="image"><img src='/2020s-1.jpg' alt='image' /></div>

    </div>

    <div class="body">
      <div class="image"><img src='/2020s-2.jpg' alt='image' /></div>
      <p>
